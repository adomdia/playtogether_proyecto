...
@section('css')
    ...
    @include('intranet.contentbuilderjs.styles')
@stop
                ...
                <div class="panel panel-bordered">
                    ...
                    <form role="form"
                        ...
                        <div class="panel-footer">
                            <button type="button" id="enviar" class="btn btn-primary save">{{ __('voyager::generic.save') }}</button>
                        </div>
                    </form>
...
@section('javascript')
    ...
    @include('intranet.contentbuilderjs.scripts')
@stop
